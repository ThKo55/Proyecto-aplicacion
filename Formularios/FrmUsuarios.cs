...
namespace AorusMarket.Formularios
{
    ...
    {
        private TextBox txtNombre, txtApellido, txtEmail, txtPassword;
        ...
        private void ConstruirInterfaz()
        {
            ...
            txtPassword = EstiloApp.CrearTextBox(new Point(x, y + 20), 220);
        ...
        private void BtnGuardar_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(txtNombre.Text) || string.IsNullOrWhiteSpace(txtApellido.Text) ||
                string.IsNullOrWhiteSpace(txtEmail.Text) || cmbPerfil.SelectedIndex == -1)
            {
                MessageBox.Show("Debe completar todos los campos obligatorios", "Error",
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            // TODO: insertar o actualizar en la base de datos (UsuarioDAL)
